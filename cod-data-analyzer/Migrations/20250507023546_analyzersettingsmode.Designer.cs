...
namespace cod_data_analyzer.Migrations
{
    ...
    [Migration("20250507023546_analyzersettingsmode")]
    partial class analyzersettingsmode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettings", b =>
                {
                    b.Property<int>("AnalyzerSettingsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnalyzerSettingsId"));

                    b.Property<int>("MatchQuitThreshold")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MinTimePlayedTopGame")
                        .HasColumnType("int");

                    b.Property<int>("MinTimePlayedTopMap")
                        .HasColumnType("int");

                    b.Property<bool>("isGameModeWhitelist")
                        .HasColumnType("bit");

                    b.Property<bool>("isMapWhitelist")
                        .HasColumnType("bit");

                    b.HasKey("AnalyzerSettingsId");

                    b.ToTable("AnalyzerSettings");
                });

            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettingsMap", b =>
                {
                    b.Property<int>("AnalyzerSettingsMapId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnalyzerSettingsMapId"));
                    ...
                    b.HasKey("AnalyzerSettingsMapId");

                    b.HasIndex("AnalyzerSettingsId");

                    b.HasIndex("MapId");

                    b.ToTable("AnalyzerSettingsMap");
                });

            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettingsMode", b =>
                {
                    b.Property<int>("AnalyzerSettingsModeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnalyzerSettingsModeId"));
                    ...
                    b.HasKey("AnalyzerSettingsModeId");

                    b.HasIndex("AnalyzerSettingsId");

                    b.HasIndex("GameModeId");

                    b.ToTable("AnalyzerSettingsMode");
                });
            ...
            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettingsMap", b =>
                {
                    b.HasOne("cod_data_analyzer.Models.AnalyzerSettings", "AnalyzerSettings")
                        .WithMany("AnalyzerSettingsMaps")
                        .HasForeignKey("AnalyzerSettingsId")
            ...
            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettingsMode", b =>
                {
                    b.HasOne("cod_data_analyzer.Models.AnalyzerSettings", "AnalyzerSettings")
                        .WithMany("AnalyzerSettingsModes")
                        .HasForeignKey("AnalyzerSettingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cod_data_analyzer.Models.GameMode", b =>
                {
                    b.HasOne("cod_data_analyzer.Models.AnalyzerSettings", null)
                        .WithMany("SelectedGameModes")
                        .HasForeignKey("AnalyzerSettingsId");
            ...
            modelBuilder.Entity("cod_data_analyzer.Models.AnalyzerSettings", b =>
                {
                    b.Navigation("AnalyzerSettingsMaps");

                    b.Navigation("AnalyzerSettingsModes");

                    b.Navigation("SelectedGameModes");

                    b.Navigation("SelectedMaps");
                });
